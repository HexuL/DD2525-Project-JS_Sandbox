...
This vulnerability exists in vm module. This vulnerability enables an attacker to commit RCE attack from vm by setting a setter triggered when trying to access it.
